...
**Bookstore** The Bookstore is a website that allows users to display a list of books,  add a book, remove a selected book. The application will be built using React and Redux in the context of a real application.
...
```sh
  ...
  git clone git@github.com:King-Benx/bookstore-react.git
...
Feel free to check the [issues page](https://github.com/King-Benx/bookstore-react/issues).

<p align="right">(<a href="#readme-top">back to top</a>)</p>

## Acknowledgement <a name="acknowledgement"></a>

I would like to thank Microverse for support rendered during this project.
